...
class config:
    ...
    single_mode_skill_prompt_disabled = (
        os.getenv("AUTO_DERBY_SINGLE_MODE_SKILL_PROMPT_DISABLED", "").lower() == "true"
    )
    ...
    single_mode_skill_label_path = os.getenv(
        "AUTO_DERBY_SINGLE_MODE_SKILL_LABEL_PATH", "data/single_mode_skill_labels.csv"
    )
    single_mode_item_class = single_mode.item.g.item_class
    single_mode_skill_class = single_mode.skill.g.skill_class
    ...
    def apply(cls) -> None:
        ...
        single_mode.skill.g.label_path = cls.single_mode_skill_label_path
        single_mode.item.g.prompt_disabled = cls.single_mode_item_prompt_disabled
        single_mode.skill.g.prompt_disabled = cls.single_mode_skill_prompt_disabled
        single_mode.item.g.item_class = cls.single_mode_item_class
        single_mode.skill.g.skill_class = cls.single_mode_skill_class
